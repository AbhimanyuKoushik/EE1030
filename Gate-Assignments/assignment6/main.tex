...
\item The unit cell volume of polyethylene \brak{\text{PE}} is $0.0933$ $nm^3$. Assuming two ethylene repeat units are contained within each unit cell, the density of a totally crystalline PE will be \rule{2.5cm}{0.4pt}$g/cm^3$. \brak{\text{Take the atomic weights for carbon and hydrogen as }12.01\text{ }g/mol\text{ and }1.008\text{ }g/mol\text{, respectively and }}\\ \brak{\text{Avagadro's number as }6.023\times 10^23\text{ repeat units/mol}}
...
\\\begin{center}
   \scalebox{0.5}{\input{figs/fig1.tex}}
\end{center}
