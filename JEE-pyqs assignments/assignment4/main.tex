...
\item If the lines $\vec{r}=\brak{\vec{i}-\vec{j}+\vec{k}}+\lambda\brak{3\vec{j}-\vec{k}}$ and $\vec{r}=\brak{\alpha\vec{i}-\vec{j}}+\mu\brak{2\vec{i}-3\vec{k}}$ are co-planar, then the distance of the plane contaioning these two lines from the point \brak{\alpha,0,0} is:
