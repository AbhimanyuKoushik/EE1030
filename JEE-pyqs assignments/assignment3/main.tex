...
\item If $\brak{\overrightarrow{a}+3\overrightarrow{b}}$ is perpendicular to $\brak{7\overrightarrow{a}-5\overrightarrow{b}}$ and $\brak{\overrightarrow{a}-4\overrightarrow{b}}$ is perpendicular to $\brak{7\overrightarrow{a}-2\overrightarrow{b}}$, then the angle between $\overrightarrow{a}$ and $\overrightarrow{b}$ \brak{\text{in degrees}} is \rule{1cm}{0.15mm}.
