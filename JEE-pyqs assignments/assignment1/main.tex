...
\hfill{\brak{\text{08-01-2020 Shift-1}}}
\begin{enumerate}
\begin{multicols}{4}
\item \brak{4,6}
\item \brak{3,4}
...
\item The locus of a point which divides the line segment joining the point \brak{0,-1} and a point on parabola, $x^2 = 4y$, internally in the ratio $1:2$ is:
